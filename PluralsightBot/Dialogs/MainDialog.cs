...
namespace FinanceBot.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        private void InitializeWaterfallDialog()
        {
            ...
            AddDialog(new PayrollDialog($"{nameof(MainDialog)}.payroll", _botStateService, _botServices));
            AddDialog(new FeedbackDialog($"{nameof(MainDialog)}.feedback", _botStateService, _botServices));
        ...
        private async Task<DialogTurnResult> InitialStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                switch (topIntent.intent)
                {
                    ...
                    case "Payroll_query":
                        return await stepContext.BeginDialogAsync($"{nameof(MainDialog)}.payroll", null, cancellationToken);
                    case "Feedback_query":
                        return await stepContext.BeginDialogAsync($"{nameof(MainDialog)}.feedback", null, cancellationToken);
                    default:
